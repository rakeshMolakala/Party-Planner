            ...
            public void onChildAdded(@NonNull DataSnapshot snapshot, @Nullable String previousChildName) {
                ...
                if (event.equals(currEvent)) {
                    ...
                    if (image.charAt(0) == 'b' && image.charAt(1) == '1') {
                        ...
                        by.setTextColor(Color.parseColor("#191970"));
                        ...
                        by.setTextColor(Color.parseColor("#8b4513"));
                        ...
                        by.setTextColor(Color.parseColor("#daa520"));
                        ...
                        by.setTextColor(Color.parseColor("#000000"));
                        ...
                        by.setTextColor(Color.parseColor("#ff8c00"));
                        ...
                        by.setTextColor(Color.parseColor("#b8860b"));
                        ...
                        by.setTextColor(Color.parseColor("#c71585"));
